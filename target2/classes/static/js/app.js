    ...
    $('#viewaccount').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            ...
            success: function (result) {   /*<ul><li>id: '+result.id+'</li><li>seqNo: '+result.seqNo+'</li></ul>*/
                ...
                //alert(result);
                var ip = '', sc = '', dowload = '';
                if (result.isDownloaded == "Y") {
                    dowload = "Yes"
                } else if (result.isDownloaded == "N") {
                    dowload = "No"
                }
                if (result.isSeniorCitizen == "Y") {
                    cs = "Yes";
                } else if (result.isSeniorCitizen == "N") {
                    cs = "No"
                }
                if (result.isPrivate == "Y") {
                    ip = "Yes";
                } else if (result.isPrivate == "N") {
                    ip = "No"
                }
