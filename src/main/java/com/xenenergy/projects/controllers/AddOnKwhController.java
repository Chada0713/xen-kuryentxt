...
import com.xenenergy.projects.services.impl.AddOnKwhServiceImpl;
...
public class AddOnKwhController {
    ...
    @Autowired
    AddOnKwhServiceImpl addOnKwhService;
    ...
    public ModelAndView showPersonsPage(@RequestParam("pageSize") Optional<Integer> pageSize,
        ...
        Pager pager = new Pager(addOnKwhs.getTotalPages(), addOnKwhs.getNumber(), BUTTONS_TO_SHOW);
